...
- [Arc Scoring](arc-scoring.md)
- [Linear Scoring](linear-scoring.md)
...
1. [Arc Scoring](arc-scoring.md) - Arc/lever mechanism analysis
2. [Linear Scoring](linear-scoring.md) - Linear elastic-powered system
3. [S Scoring](S-scoring.md) - S-shaped path variation
4. [C Scoring](C-scoring.md) - C-shaped path variation
